        ...
        <div class="card rounded card-form__body card-body shadow-lg">
            ...
            <div class="form-group mb-10 col-md-3">
                ...
                <select class="form-control"  name='action'>
                    <option value='SELL' @if( $recommendation->status == 'SELL' ) selected @endif>SELL</option>
                    <option value='BUY'  @if( $recommendation->status == 'BUY' ) selected @endif>BUY</option>
                </select>
            </div>
            <div class="form-group mb-10 col-md-3">
            ...
            <div class="form-group mb-10 col-md-4">
                ...
                <input type='datetime-local' name="opening_time" class="form-control" value="{{ $recommendation->opening_time }}" />
            </div>
            <div class="form-group mb-10 col-md-4">
            ...
            <div class="form-group mb-10 col-md-6">
                <label for="exampleFormControlInput1" class="required form-label">@lang('site.Trade Probability') </label>
                <input type='text' name="trade_probability" class="form-control" value="{{ $recommendation->trade_probability }}" />
            </div>
