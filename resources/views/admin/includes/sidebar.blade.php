                 ...
                 @if (auth()->user()->hasRole(['admin']))
                       ...
                       <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        <span class="menu-link">
                            ...
                            <span class="menu-title">@lang('site.Recommendations')</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <div class="menu-sub menu-sub-accordion menu-active-bg">
                            <div class="menu-item">
                                <a class="menu-link" href="{{ route('recommendation.index') }}">
                    ...
                    <!-- end recommendations -->
                         ...
                         <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                            <span class="menu-link">
                                ...
                                <span class="menu-title">@lang('site.Levels')</span>
                                <span class="menu-arrow"></span>
                            </span>
                            <div class="menu-sub menu-sub-accordion menu-active-bg">
                                <div class="menu-item">
                        ...
                        <!-- end vip -->
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">@lang('site.vip')</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                                        <a class="menu-link" href="{{ route('vip.index') }}">
                                            <span class="menu-bullet">
                                                <span class="bullet bullet-dot"></span>
                                            </span>
                                            <span class="menu-title">@lang('site.vip')</span>
                            ...
                            <!-- end Vip -->
                             ...
                             <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">@lang('site.currency')</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
                            ...
                            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                <span class="menu-link">
                                    ...
                                    <span class="menu-title">@lang('site.Academy')</span>
                                    <span class="menu-arrow"></span>
                                </span>
                                <div class="menu-sub menu-sub-accordion menu-active-bg">
                                    <div class="menu-item">
...
{{--
    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                     ...
                     @if (auth()->user()->hasRole(['vendor']))
                                      ...
                                      <!-- vendor edit resturant -->
                     <div class="menu-item">
                         <a class="menu-link" href="{{ route('updateresturant.vendor') }}">
                             <span class="menu-icon">
                             <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                         viewBox="0 0 24 24" version="1.1">
                                         <path
                             ...
                             <span class="menu-title">@lang('site.My Resturant')</span>
                         </a>
                     </div>

                     <!-- end vendor edit resturant -->
